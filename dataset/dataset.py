...
def get_FF_dataset(dataset_path, mode=None, category_list=['Deepfakes', 'Face2Face', 'FaceSwap', 'NeuralTextures'], \
    ...
    """
    Build FaceForensics++ dataset with multi-class label. Label '0' refers to pristine images. Label greater than 0 
    refers to fake images.
    
    Args:
        dataset_path (str): Path to FaceForensics++ dataset. (Top dir)
        mode (str): Choose from 'train', 'valid' and 'test'
        category_list (list): Fake images generated by the method in list will be involved in dataset.
        isTrain (bool): If in train mode, oversampling the real images.
    """
...
def get_FF_5_class(dataset_path, mode=None, category_list=['Deepfakes', 'Face2Face', 'FaceSwap', 'NeuralTextures'], \
    ...
    """
    Build FaceForensics++ dataset with binary label. '0' refers to pristine images and '1' to fake.
